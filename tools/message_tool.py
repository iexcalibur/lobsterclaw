...
def set_telegram_fns(
    ...
    global _send_photo_fn, _send_document_fn, _edit_fn, _delete_fn, _react_fn, _send_buttons_fn
    if send_photo:
...
TOOL_DEFINITION = ToolDefinition(
    ...
    parameters={
        ...
        "properties": {
            "action": {
                "type": "string",
                "description": "Action: send | send_photo | send_document | edit | delete | react | buttons",
                "default": "send",
            },
            "text": {
                "type": "string",
...
async def _message(
    ...
    return f"Unknown action '{action}'. Use: send, send_photo, send_document, edit, delete, react, buttons"
